  ...
  return (
    <div className="p-4 space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        >
          <div className="font-mono text-[9px] tracking-widest mb-1" style={{ color: 'rgba(0,255,148,0.6)' }}>
            TOTAL FLOWS
          </div>
          <div className="font-display font-bold text-[22px]" style={{ color: 'rgba(0,255,148,0.9)' }}>
            {flows.length}
          </div>
        </div>
      </div>

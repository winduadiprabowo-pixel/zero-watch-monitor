    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '3px', flexWrap: 'wrap' as const }}>
          <span style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: '13px', fontWeight: 700, color: tx.isMega ? 'rgba(251,191,36,1)' : 'rgba(0,255,148,1)' }}>
            {fmtUsd(tx.valueUsd)}
          </span>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexShrink: 0 }}>
        <a
          ...
          onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.borderColor = 'rgba(0,255,148,0.3)' }}
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: '16px',
        overflow:     'hidden',
        background:   'linear-gradient(135deg, rgba(0,255,148,0.04) 0%, rgba(99,102,241,0.03) 100%)',
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 12px', borderBottom: '1px solid rgba(255,255,255,0.055)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
          <div style={{ width: '6px', height: '6px', minWidth: '6px', borderRadius: '50%', background: 'rgba(0,255,148,1)', boxShadow: '0 0 6px rgba(0,255,148,0.8)', animation: 'pulse-glow 2s ease-in-out infinite' }} />
          <Eye style={{ width: '12px', height: '12px', color: 'rgba(0,255,148,0.7)', flexShrink: 0 }} />
          <span style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: '9px', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: 'rgba(0,255,148,0.9)', whiteSpace: 'nowrap' as const }}>
            Unknown Whale
          </span>
          <span style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: '8px', padding: '2px 8px', borderRadius: '99px', background: 'rgba(0,255,148,0.08)', color: 'rgba(0,255,148,0.6)', border: '1px solid rgba(0,255,148,0.15)', flexShrink: 0 }}>

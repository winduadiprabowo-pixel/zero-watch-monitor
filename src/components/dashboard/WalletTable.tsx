      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'flex-end', paddingRight: '14px', gap: '6px' }}>
        ...
        {walletCount > 1 && (
          <span style={{
            ...
            border: isExpanded ? '1px solid rgba(0,255,136,0.12)' : '1px solid rgba(255,255,255,0.08)',
            borderRadius: '4px',
            padding: '1px 5px',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
          ...
          {wallet.txNew > 0 && (
            <span style={{
              ...
              border: '1px solid rgba(0,255,136,0.18)', borderRadius: '99px',
    ...
    >
      ...
      <div style={{ flex: '0 0 160px', minWidth: 0, paddingRight: '8px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
          ...
          {wallet.txNew > 0 && <span style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: '8px', fontWeight: 700, color: 'rgba(0,255,136,1)', background: 'rgba(0,255,136,0.08)', border: '1px solid rgba(0,255,136,0.18)', borderRadius: '99px', padding: '0 4px', lineHeight: '14px', flexShrink: 0 }}>{wallet.txNew}</span>}
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', marginTop: '1px' }}>
...
const WalletTable = memo(({
  ...
  if (loading) {
    return (
      <div style={{ flex: 1, overflow: 'hidden' }}>
        <div className="flex items-center gap-0 px-0" style={{ height: '32px', borderBottom: '1px solid rgba(255,255,255,0.055)', background: 'rgba(255,255,255,0.015)' }}>
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden' }}>
      <div
        className="flex items-center sticky top-0 z-10"
        style={{ height: '30px', borderBottom: '1px solid rgba(255,255,255,0.055)', background: 'rgba(6,6,12,0.98)', backdropFilter: 'blur(8px)' }}
      >
        <div style={{ width: '36px', flexShrink: 0 }} />
        <div style={{ width: '16px', flexShrink: 0 }} />

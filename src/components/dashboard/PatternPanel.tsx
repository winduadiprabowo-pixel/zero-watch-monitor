      ...
      <div style={{ padding: '12px 16px 10px', flexShrink: 0 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '6px', marginBottom: '10px' }}>
          {[
            ...
            { label: 'TOTAL',    value: patterns.length,          color: 'rgba(0,255,148,0.9)', bg: 'rgba(0,255,148,0.04)', border: 'rgba(0,255,148,0.15)' },
          ].map(s => (
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '0 16px 16px', minHeight: 0 }}>
        ...
        {!loading && !error && patterns.length === 0 && (
          <div style={{ textAlign: 'center' as const, padding: '32px 16px' }}>
            <Shield style={{ width: '28px', height: '28px', color: 'rgba(0,255,148,0.3)', margin: '0 auto 10px' }} />

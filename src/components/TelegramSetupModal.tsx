        ...
        <div className="relative px-6 pt-6 pb-7 space-y-5">
          <DialogHeader>
            <div className="flex items-center gap-2">
              <Send className="w-4 h-4" style={{ color: 'rgba(0,255,148,0.7)' }} />
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-2">
                <span
                  ...
                  style={{ background: 'rgba(0,255,148,0.15)', color: 'rgba(0,255,148,0.9)', border: '1px solid rgba(0,255,148,0.25)' }}
                >
                  1
                </span>
                <span className="text-[10px] font-mono" style={{ color: 'rgba(255,255,255,0.7)' }}>
                  Buka bot dan ketik <code style={{ color: 'rgba(0,255,148,0.8)' }}>/start</code>
                </span>
              </div>
              <a
            ...
            >
              ...
              <button
                ...
                style={{
                  background:    input.trim() ? 'linear-gradient(135deg, rgba(0,255,148,1), rgba(0,200,120,1))' : 'rgba(255,255,255,0.05)',
                  color:         input.trim() ? '#020a06' : 'rgba(255,255,255,0.25)',
            ...
            {tg.enabled && (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  {testDone && <CheckCircle2 className="w-4 h-4" style={{ color: 'rgba(0,255,148,0.8)' }} />}
          ...
          >
            ...
            <span
              ...
              style={{ color: tg.enabled ? 'rgba(0,255,148,0.9)' : 'rgba(255,255,255,0.25)' }}
            >
